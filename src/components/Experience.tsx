...
//   const skillsMarqueeText = `${skillGroups.flatMap((skill) => skill.items).join(' ✦ ')} ✦`;
...
//           <motion.article
//             ref={videoRef}
//             className="relative min-h-[320px] overflow-hidden rounded-[1.25rem] sm:min-h-[420px] lg:min-h-[460px]"
